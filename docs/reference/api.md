...
| `GET` | `/api/v1/settings` | admin/owner | Runtime operational settings: schema + current values |
| `PATCH` | `/api/v1/settings` | admin/owner | Update one or more runtime settings (validated against the allowlist) |
