...
the **XTV-SupportBot** community a harassment-free experience for everyone,
...
standards. They have the right and responsibility to remove, edit, or reject
...
repository, the `@XTVbots` channel, any linked support groups, and when an
