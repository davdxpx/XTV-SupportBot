...
v0.9 is stabilising the public-pre-release surface. On the way to v1.0:

- Agent cockpit with saved filters + bulk actions
- Full automation rules engine (if-this-then-that over ticket events)
- Project templates (seed a new project with macros / KB / routing / SLA)
- REST API write endpoints (reply / close / assign via HTTP)
- Per-user notification preferences + onboarding panel rework
